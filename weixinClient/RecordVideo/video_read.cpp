...
//        case no_icon:break;
//        case tuzi:
//            imgPath = QCoreApplication::applicationDirPath()+ "/tuer.png";
//            break;
//        case hat:
//            imgPath = QCoreApplication::applicationDirPath()+ "/hat.png";
//            break;
//        }
//        strPath = imgPath.toStdString();
//        Mat tutu = imread( strPath );
//        Mat mask = imread( strPath , 0);//灰阶
//        for( int i = 0; i < m_lastfaces.size()  ; i++ )
//        {

//            Rect rct = m_lastfaces[i];

//            int px = rct.x + rct.width*0.5 - tutu.cols*0.5 + 20;
//            int py = rct.y - tutu.rows;
//            if( px > 0 && px + tutu.cols < frame.cols
//                    && py > 0 && py + tutu.rows < frame.rows )
//            {
//                Mat imageROI = frame(Rect( px , py , tutu.cols, tutu.rows)); //起始点 宽高
//                tutu.copyTo(imageROI, mask);
//            }
//        }
    }
